        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute("type") === "checkbox") {
              i === 0 ? state[prop] = "Холоднно" : state[prop] = "Теплое";
              elem.forEach((box, j) => {
                box.checked = false;
                if (i === j) {
                  box.checked = true;
...
/* harmony export */ });
const modals = state => {
  function bindModal(triggerSelector, modalSelector, closeSelector, closeClickOverlay = true, requiredInputs = []) {
  ...
  bindModal(".popup_calc_button", ".popup_calc_profile", ".popup_calc_profile_close", false, ["form"]);
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false, ["type"]);
